...
public class StringTransformEditor extends HBox implements TransformEditor {
    ...
    public StringTransformEditor(QueryParameterTransform t, QueryBuilderExtension ext) {
        setSpacing(6);
    ...
    public void build() {
        ...
        editor.setPromptText("Enter value");
